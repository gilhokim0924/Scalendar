...
async function main() {
  ...
  console.log(`Starting baseball sync for ${SEASON}`);
  ...
  console.log(`Baseball sync complete: ${allTeams.length} teams, ${allEvents.length} events, ${standings.length} standings rows`);
}
